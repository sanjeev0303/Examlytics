    ...
    <footer>
        <div className="relative w-full overflow-hidden rounded-t-3xl border-t border-white/5 bg-[#03030c]/50 backdrop-blur-md min-h-100 flex flex-col justify-end mt-12">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0 overflow-hidden">
               <span className="text-[15vw] font-bold font-heading bg-[url('/landing_background.webp')] bg-cover bg-center bg-clip-text text-transparent tracking-tighter leading-none opacity-50 blur-[1px]">
                 Examlytics
               </span>
            </div>

            {/* Surface Noise/Texture (Optional subtle grain) */}
            <div className="absolute inset-0 opacity-[0.03] bg-[url('/noise.webp')] mix-blend-overlay pointer-events-none z-0" />
