                    ...
                    <div className="flex justify-center py-4">
                        <div className="w-full space-y-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="p-2 rounded border bg-background text-muted-foreground">{user?.firstName}</div>
                            </div>
                            <div className="grid gap-2">
                                <Label>Last Name</Label>
                                <div className="p-2 rounded border bg-background text-muted-foreground">{user?.lastName}</div>
                            </div>
                            <div className="grid gap-2">
                                <Label>Email</Label>
                                <div className="p-2 rounded border bg-background text-muted-foreground">{user?.email}</div>
                            </div>
                        </div>
                    </div>
                </CardContent>
                    ...
                    <CardContent className="space-y-8">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-border/40">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked: boolean) => setTheme(checked ? 'system' : 'light')}
                            />
                        </div>
                    </CardContent>
                </Card>
